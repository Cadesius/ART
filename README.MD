...
- The program will work with both local directories and those on shared network drives (ie. Samba shares), although network administrators may override this functionality.